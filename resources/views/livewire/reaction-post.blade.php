<div class="cursor-pointer">
  @if($type == 'thumbup')
    @if(Maize\Markable\Models\Reaction::has($post,Auth::user(),'thumbup'))
      <a wire:click="unreact" class="rounded-full text-center pt-1 text-green-600" alt="thumbup-on">
    ...
    @else
      <a wire:click="react"   class="rounded-full text-center pt-1 text-green-400" alt="thumbup-off">
  ...
  @if($type == 'heart')
    @if(Maize\Markable\Models\Reaction::has($post,Auth::user(),'heart'))
      <a wire:click="unreact" class="rounded-full text-center pt-1 text-green-600" alt="heart-on">
    ...
    @else
      <a wire:click="react"   class="rounded-full text-center pt-1 text-green-400" alt="heart-off">
  ...
  @if($type == 'star')
    @if(Maize\Markable\Models\Reaction::has($post,Auth::user(),'star'))
      <a wire:click="unreact" class="rounded-full text-center pt-1 text-green-600" alt="star-on">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" viewBox="0 0 20 20" fill="currentColor"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" /></svg>
      </a>
    @else
      <a wire:click="react"   class="rounded-full text-center pt-1 text-green-400" alt="star-off">
  ...
  @if($type == 'thumbdown')
    @if(Maize\Markable\Models\Reaction::has($post,Auth::user(),'thumbdown'))
      <a wire:click="unreact" class="rounded-full text-center pt-1 text-red-400" alt="thumbdown-on">
    ...
    @else
      <a wire:click="react"   class="rounded-full text-center pt-1 text-red-300" alt="thumbdown-off">
  ...
  @if($type == 'brokenheart')
    @if(Maize\Markable\Models\Reaction::has($post,Auth::user(),'brokenheart'))
      <a wire:click="unreact" class="rounded-full text-center pt-1 text-red-400" alt="brokenheart-on">
    ...
    @else
      <a wire:click="react"   class="rounded-full text-center pt-1 text-red-400" alt="brokenheart-off">
  ...
  @if($type == 'unhappy')
    @if(Maize\Markable\Models\Reaction::has($post,Auth::user(),'unhappy'))
      <a wire:click="unreact" class="rounded-full text-center pt-1 text-red-400" alt="unhappy-on">
    ...
    @else
      <a wire:click="react"   class="rounded-full text-center pt-1 text-red-400" alt="unhappy-off">
